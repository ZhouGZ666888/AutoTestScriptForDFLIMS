...
class ConfigHandler:
    ...
    @classmethod
    def _parse_list_glob(self, value, separator=','):
        ...
        """
        glob_characters = ('*', '?', '[', ']', '{', '}')
        values = self._parse_list(value, separator=separator)
        expanded_values = []
        for value in values:
    ...
    def _parse_dict(self, value):
        ...
        separator = '='
        result = {}
        for line in self._parse_list(value):
    ...
    @classmethod
    def _exclude_files_parser(self, key):
    ...
    def _parse_file(self, value):
        ...
        return '\n'.join(
            ...
            if (self._assert_local(path) or True) and os.path.isfile(path)
        )
    ...
    @classmethod
    def _parse_attr(self, value, package_dir=None):
    ...
    @classmethod
    def _get_parser_compound(self, *parse_methods):
    ...
    @classmethod
    def _parse_section_to_dict(self, section_options, values_parser=None):
