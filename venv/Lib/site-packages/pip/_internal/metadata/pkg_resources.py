...
class Distribution(BaseDistribution):
    ...
    @classmethod
    def from_wheel(self, wheel: Wheel, name: str) -> "Distribution":
...
class Environment(BaseEnvironment):
    ...
    @classmethod
    def default(self) -> BaseEnvironment:
        return self(pkg_resources.working_set)

    @classmethod
    def from_paths(self, paths: Optional[List[str]]) -> BaseEnvironment:
        return self(pkg_resources.WorkingSet(paths))
