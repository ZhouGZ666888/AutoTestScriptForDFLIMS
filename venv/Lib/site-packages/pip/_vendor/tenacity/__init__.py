...
class BaseRetrying(ABC):
    def __init__(
        ...
        reraise: bool = False,
        retry_error_self: t.Type[RetryError] = RetryError,
        ...
        self.retry_error_self = retry_error_self
    ...
    def copy(
        ...
        retry_error_self: t.Union[t.Type[RetryError], object] = _unset,
        ...
        return self.__class__(
            ...
            retry_error_self=_first_set(retry_error_self, self.retry_error_self),
    ...
    def iter(self, retry_state: "RetryCallState") -> t.Union[DoAttempt, DoSleep, t.Any]:  # noqa
        ...
        if self.stop(retry_state=retry_state):
            ...
            retry_exc = self.retry_error_self(fut)
            if self.reraise:
...
class Future(futures.Future):
    ...
    @classmethod
    def construct(self, attempt_number: int, value: t.Any, has_exception: bool) -> "Future":
        """Construct a new Future object."""
        fut = self(attempt_number)
        if has_exception:
...
class RetryCallState:
    ...
    def __repr__(self):
        ...
        return f"<{selfname} {id(self)}: attempt #{self.attempt_number}; slept for {slept}; last result: {result}>"
