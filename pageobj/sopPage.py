...
from PageElements.sop_ele import *
...
class SopPage(BasePage):
    ...
    def creat_sop(self, sop_name, module_value, type_value):
        ...
        self.clicks('css', sop_detail_sopname_type)
        self.sleep(0.5)
        print(sop_detail_sopname_type_value.format(str(type_value)))
        self.clicks('xpath', sop_detail_sopname_type_value.format(str(type_value)))
        self.sleep(0.5)
        log.info("详情页，选择sop所属实验地点")
        self.clicks('css', sop_selectedLaboratory)
        self.sleep(0.5)
        self.clicks('xpath', sop_selectedLaboratory_choice)
        ...
        self.clicks('css', sop_detail_save_butten)
        self.sleep(0.5)
        self.wait_loading()

        log.info("详情页，点击【新增产物类型】按钮")
        self.clicks('css', sop_detail_product)
        self.sleep(1)
        log.info("详情页，点击【新增产物类型】按钮后，点击搜索原始样本类型弹框")
        self.click_by_js('css', sop_detail_original_sample_type)
        self.sleep(0.5)
        ...
        self.clicks('css', sop_detail_add_step)
        self.sleep(1)

        log.info("详情页，点击同步编号按钮")
        self.click_by_js('css', sop_detail_add_restep)
        self.sleep(0.5)

        log.info("详情页，使用JS让页面滑动到最顶端，点击sop生效按钮")
        self.executeJscript(scroll_view)
        self.sleep(0.5)
        self.click_by_js('css', sop_effect_button)
        self.sleep(1)
