...
class LibraryenrichMent(MyTest):
    ...
    # def test06_add_libraryenrichment_task_probe(self):
    ...
    #     self.assertEqual(info, "任务单保存成功", "保存样本到明细表失败！！")
    #
    # def test07_libraryenrichment_detail_probe(self):
    ...
    #     self.assertEqual(res_info, '是', '生成结果失败!')
    #
    # def test08_libraryenrichment_result_probe(self):
    ...
    #     self.assertEqual(pageinfo1, '是', '提交失败!')
    #
    # def test09_detail_submit_probe(self):
    ...
    #     self.assertEqual(save_info3[6:].strip(), '完成', '完成任务单失败！')
    #
    # def test10_search_task_by_lims_probe(self):
