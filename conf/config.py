...
from conf.all_path import sampleprocessing_file_path, hstq_file_path_mNGS, wkgj_file_path, hstq_file_path_dxk, \
    ...
    report_basic_info_process_path,mpcr_file_path
...
def create_lab_excel():
    ...
    write_excel_xlsx_by_openpyxl(mpcr_file_path, all_laboratorys[-1], value)  # 写入报告样本数据流转Excel
