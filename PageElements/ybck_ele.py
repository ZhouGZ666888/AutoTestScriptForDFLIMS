...
#弹框中选择第一个探针
sampleReceive_ck_probe_value=('//*[@class="el-dialog el-dialog--center multi-table-dialog"]//span[@class="vxe-cell--label" and text()="AA(PRIME_v5.0.0)/201902-425"]')
#点击确定按钮
sampleReceive_ck_probe_confirm=('//*[@aria-label="预设探针"]//div[@class="el-dialog__footer"]//span[@class="dialog-footer"]//button[@class="el-button qcResult-btn-confirm el-button--primary el-button--medium"]')
#点击保留原项目信息按钮
