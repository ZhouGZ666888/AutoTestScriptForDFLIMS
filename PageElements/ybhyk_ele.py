...
"""
#点击选择盒子搜索按钮
ybhyk_detail_search_box=('//*[@class="el-button baseClass-btn-show-move-search-box el-button--primary el-button--small"]')

#弹框中，点击输入框
ybhyk_detail_search_box_name=('//*[@class="el-input el-input--medium el-input-group el-input-group--prepend"]//input')

#新弹框中，点击右侧弹出的输入框
ybhyk_detail_enter_value=('//*[@class="moveSearch_box2-form-textareaValue el-textarea el-input--medium"]/textarea')
...
#勾选盒子后，点击加入明细表
ybhyk_detail_add_to_list=('//*[@class="el-button baseClass-btn-add-box el-button--primary el-button--small"]')

#点击进入明细表
ybhyk_detail_go_to_list=('//*[@class="el-button baseClass-btn-go-detail el-button--primary el-button--small"]')
...
ybhyk_detail_list_select_storage=('//*[@class="el-button baseClass-btn-show-sample-box-storage el-button--primary el-button--small"]')

#选择库位弹框中输入指定的库位信息
ybhyk_detail_list_select_storage_value=('//*[@class="dialogSearch_storage-form-storageName el-input el-input--medium el-input-group el-input-group--prepend el-input--suffix"]//input')

#选择库位弹框中输入指定的库位信息,点击搜索
ybhyk_detail_list_select_storage_search=('//*[@class="el-button baseClass-btn-search el-button--primary el-button--medium"]')
...
#点击确认
ybhyk_detail_list_select_confirm=('//*[@class="el-dialog el-dialog--center dialog-search-storage" ]//span//button[@class="el-button baseClass-btn-confirm el-button--primary el-button--medium"]')

#点击提交按钮
ybhyk_detail_list_submit='//*[@class="el-button baseClass-btn-commit el-button--primary el-button--medium" ]'
...
"""
#搜索盒位信息在哪个任务单，搜索按钮
ybhyk_list_search_box='.filter-container .baseClass-btn-search-sample-box'

#搜索弹框中，输入盒子信息
ybhyk_list_search_boxname=('//*[@class="moveSearch_box-form-sampleBoxName el-input el-input--medium el-input-group el-input-group--prepend el-input--suffix" ]//input')
...
#点击【样本筛选】按钮
ybyk_detail_select_button=('//*[@class="el-button baseClass-btn-show-move-search el-button--primary el-button--small"]')
#点击LIMS号搜索框
ybyk_detail_sample_enter=('//*[@class="moveSearch_sample-form-sampleIdLims el-input el-input--medium el-input-group el-input-group--prepend"]//input')
#点击右侧弹框中的输入框
ybyk_detail_sample_value=('//*[@class="sampleIdLims-form-textareaValue el-textarea el-input--medium"]//textarea')
#输入完数据后，点击确定按钮
ybyk_detail_sample_confirm=('//*[@class="drawer-footer"]//button[@class="el-button baseClass-btn-jdrawer-confirm el-button--primary el-button--medium"]')



#点击确定按钮，确认搜索
ybyk_detail_sample_search_confirm=('//*[@class="el-dialog el-dialog--center dialog-search-sample" ]//span//button[@class="el-button baseClass-btn-confirm el-button--primary el-button--medium"]')
...
#勾选样本后，点击加入明细表
ybyk_detail_add_to_list=('//*[@class="el-button baseClass-btn-add-box el-button--primary el-button--small"]')
#点击进入明细表
ybyk_detail_go_to_list=('//*[@class="el-button baseClass-btn-go-detail el-button--primary el-button--small"]')
...
#点击选择盒位的按钮
ybyk_detail_list_select_storage=('//*[@class="el-button baseClass-btn-search-sample-box el-button--primary el-button--small"]')

#选择库位弹框中输入指定的盒子信息
ybyk_detail_list_select_storage_value=('//*[@class="dialogSearch-form-boxName el-input el-input--medium el-input-group el-input-group--prepend el-input--suffix"]//input')
...
#点击提交按钮
ybyk_detail_list_submit=('//*[@class="el-button baseClass-btn-commit el-button--primary el-button--medium"]')
...
"""
#列表页，搜索样本按钮
ybyk_list_search_button='.filter-container .baseClass-btn-search-sample'
#弹框中输入taskid
