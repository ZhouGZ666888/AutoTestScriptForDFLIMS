...
# 筛选条件，选择项目号
project_num_chioce = (
    '//*[@class="el-select-dropdown el-popper"]/descendant::li[child::span[text()="J019"]]')

# 筛选条件，s上机日期
SeqTimeDate = (
    '.reportWritingTaskAssignment-form-actualSeqTimeValue input')

# 筛选按钮
search_btn = (
    '.search-button-list .baseClass-btn-filter')

# 重置按钮
reset_btn = (
    '.search-button-list .baseClass-btn-reset')

# 筛选报告结果
result_report_search = (
    '.sample_receive_detail .vxe-table--fixed-left-wrapper .vxe-table--body-wrapper tbody tr td:nth-child(3)')
